...
参数描述：
{
  "shopId":12345，	  //广告的id,使用的是之前定义的requestBean类，命名依照之前
...
参数描述：
{
  "shopid":12345，	//根据广告的id，删除正在展示的广告，使用的是之前定义的requestBean类，命名依照之前
}
响应格式：json
参数描述：
{
...
参数描述：
{
  "shopid":12345，	//根据广告的id，删除正在展示的广告
}
响应格式：json
参数描述：
{
