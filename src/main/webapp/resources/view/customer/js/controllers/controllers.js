angular.module('PNS.controllers',['PNS.services'])
    .controller('OwnerCtrl', function OwnerCtrl($scope, CustomerService, $location, $rootScope) {
        $scope.username = null;
        $scope.err_message = null;

        $('#login-button').click(function () {
            CustomerService.signin( $scope.username, $scope.password).then(function (data) {
        ...
        $('#regist-button').click(function () {
            CustomerService.signup( $scope.username, $scope.password).then(function (data) {
                $location.path('/emp-rent');
            }, function (data) {
                console.log("user data="+"");
                console.log(data)
    ...
    .controller('AdminCtrl', function ($scope,$rootScope,ToolService,CustomerService) {
        $scope.rentInfo = null;
        $scope.toolInfo = null;
        $scope.userInfo = null;
        ...
        CustomerService.findAllUsers().then(function (data) {
            $scope.userInfo = data;
