...
<div class="user_style   clearfix">
    ...
    <div class="info_content">
       <div class="collect_style r_user_style">
        <div class="title_Section"><span   class="title_ASD">User Collect Shop</span></div>
         <div class="collect">
			     ...
			     <div class="Paging">
					    <div class="Pagination">
							<c:choose>
								...
								<c:when test="${currentPage>1}"><a href="/listCollectShop?requestPage=${currentPage-1}" class="pn-prev disabled">&lt;Previous</a></c:when>
							</c:choose>
							<c:forEach begin="1" end="${sina+1}" step="1" var="cs">
								<a href="/listCollectShop?requestPage=${cs}" class="on">${cs}Page</a>
							</c:forEach>
							<c:if test="${currentPage<=sina}">
								<a href="/listCollectShop?requestPage=${currentPage+1}">
									Next&gt;
								</a>
							</c:if>
