    ...
    <ul>
        ...
        <li  class="hiden">
            <ul>
                ...
                <li><a href="/admin/shopmanage" target="main-frame"><i class="iconfont leftIco">&#xe620;</i>ShopList</a></li>
        ...
        <li><a href="#" class="headList list3"><i class="iconfont leftIco">&#xe62c;</i>CustomerManage<i class="iconfont rightIco">&#xe613;</i></a></li>
         ...
         <%-- <li><a href="#" class="headList list4"><i class="iconfont leftIco">&#xe62c;</i>First<i class="iconfont rightIco">&#xe613;</i></a></li>
          <li class="hiden">
              <ul>
                  <li><a href="#"><i class="iconfont leftIco">&#xe620;</i>Main</a></li>
                  <li><a href="#"><i class="iconfont leftIco">&#xe620;</i>Main</a></li>
          ...
          <li><a href="#" class="headList list5"><i class="iconfont leftIco">&#xe62c;</i>First<i class="iconfont rightIco">&#xe613;</i></a></li>
          <li class="hiden">
              <ul>
                  <li><a href="#"><i class="iconfont leftIco">&#xe620;</i>Main</a></li>
                  <li><a href="#"><i class="iconfont leftIco">&#xe620;</i>Main</a></li>
